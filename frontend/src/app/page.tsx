...
import { FileText, Package, Scissors, TrendingUp } from 'lucide-react'
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Welcome to MarkerMind - your cutting optimization platform
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <Link href="/patterns">
                <Button variant="outline" className="w-full">Upload Pattern</Button>
              </Link>
            </CardContent>
          </Card>
          <Card>
